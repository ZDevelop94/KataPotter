...
The use case below was implemented: 
Note the program is not yet smart enough to distinguish between two possible sets and calculate what is the cheaper option
